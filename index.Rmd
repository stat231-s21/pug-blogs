...
From attacking the COVID pandemic, to politics, the environment and sports – oh my! -- we found data science to be a tool for empowerment, while also creating space for joy.  (At least, I hope you’d agree!)  To that end, here’s a little **Ode to Data**:
<br>
<br>
We use data
...
We amuse ourselves with data
	...
	To identify directions to allay naysayers <br>
